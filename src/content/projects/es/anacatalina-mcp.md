...
learnings:
  - "Integración exitosa del protocolo emergente MCP, adaptando la arquitectura para soportar comunicación bidireccional asíncrona mediante Streamable-HTTP."
...
Esto permite que cualquier cliente LLM que soporte MCP (como Claude.ai o editores IDE como Cursor o Windsurf) pueda conectarse al servidor y ejecutar herramientas (tools) predefinidas para consultar mi stack tecnológico, proyectos destacados y experiencia profesional, procesando los datos de forma estructurada e interactiva en lugar de leer texto plano o realizar web scraping.

### ⚡ Conexión Rápida (Claude & Cursor)
...
**Claude** lo admite agregandolo en su configuración. Se debe agregar la siguiente URL como conector personalizado:
...
El servidor está desarrollado en **Python 3.12** utilizando **FastMCP** y el streaming bidireccional mediante **Streamable-HTTP**. Toda la validación de tipos e inputs de las tools está estrictamente garantizada por **Pydantic v2**, generando los esquemas JSON necesarios para la declaración dinámica en los LLMs.
